...
export default function Benefits() {
  return (
    <div className="flex flex-col gap-4">
                <p className="font-semibold  text-white">Additional Benefits</p>
                <div className="flex flex-col md:flex-row gap-[30px]">
                    ...
                    <div className="benefit-card flex items-center gap-[14px] p-[14px_20px] ring-1 ring-white rounded-[20px]">
                        ...
                        <div className="flex flex-col gap-[2px]">
                            <p className="font-bold text-lg  text-white">Safe Guard</p>
                    ...
                    <div className="benefit-card flex items-center gap-[14px] p-[14px_20px] ring-1 ring-white rounded-[20px]">
                        ...
                        <div className="flex flex-col gap-[2px]">
                            <p className="font-bold text-lg  text-white">Home Pickup</p>
