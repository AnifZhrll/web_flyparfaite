    ...
    <div className="flex flex-col gap-[30px] w-[400px]">
                <div className="flex flex-col gap-[18px]">
                    ...
                    <div className="flex justify-between">
                        ...
                        <span className="font-semibold">{data?.flightDetail?.price ? rupiahFormat(data.flightDetail.price + 
                            selectedSeat.additionalPrice) : 0}</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                        ...
                        {data?.flightDetail?.price ? rupiahFormat(data.flightDetail.price + selectedSeat.additionalPrice) : 0}
                        </span>
                    </div>
                </div>
                <button 
                    ...
                    disabled={isLoading}
                    className="font-bold text-flysha-black bg-flysha-light-purple rounded-full h-12 w-full transition-all 
                    duration-300 hover:shadow-[0_10px_20px_0_#B88DFF] flex justify-center items-center"
                >
