...
export default async function HomePage() {
  ...
  return (
    ...
    <div className="Header-content bg-gradient-to-r from-[#080318] to-[rgba(8,3,24,0)] z=0">
        ...
        <div className="hero-section container max-w-[1130px] w-full mx-auto flex flex-col gap-[90px] mt-[103px]">
            <div className="title flex flex-col gap-[30px]">
                <h1 className="font-extrabold text-[80px] leading-[90px] text-white">Best Flights. <br />Cheaper Budget.</h1>
                <p className="font-medium text-lg leading-[36px] text-white">No more long queue, get more delicious heavy meals. <br />Crafted by best talented people around the world.</p>
            </div>
            <form action={searchFlight} className="bg-white text-flysha-black w-full flex justify-between items-center rounded-[20px] p-5">
                <div className="flex gap-[50px] items-center p-5">
                    <div className="flex flex-col justify-center gap-[14px]">
                        ...
                        <div className="flex gap-[10px]">
                            <div className="flex items-center w-8 h-8 shrink-0">
                                <Image width={150} height={60} src="/assets/images/icons/airplane.svg" alt="icon" />
                            </div>
                    ...
                    <div className="flex flex-col justify-center gap-[14px]">
                        ...
                        <div className="flex gap-[10px]">
                            <div className="flex items-center w-8 h-8 shrink-0">
                                <Image width={150} height={60} src="/assets/images/icons/calendar.svg" alt="icon" />
                            </div>
                ...
                <button type="submit" className="font-bold text-2xl leading-9 text-flysha-black text-center bg-flysha-light-purple rounded-[18px] p-[12px_30px] flex shrink-0 items-center h-[108px]  transition-all duration-300 hover:shadow-[0_10px_20px_0_#B88DFF]">Explore Now</button>
            </form>
        </div>
        <CompanyLogos />
    </div>
    ...
    <h2 className="font-bold text-[32px] leading-[48px] text-center  text-white">We Ensure You <br />Fly With Us Forever</h2>
    <div className="flex justify-between">
        <div className="flex flex-col gap-[30px] w-[220px]">
            ...
            <div className="flex flex-col gap-1">
                <p className="font-bold text-2xl leading-[36px] text-white">Talented Crew</p>
        ...
        <div className="flex flex-col gap-[30px] w-[220px]">
            ...
            <div className="flex flex-col gap-1">
                <p className="font-bold text-2xl leading-[36px] text-white">Safe Guard</p>
                <p className="leading-[30px] text-flysha-off-purple">Our jets protected by metal that can’t be destroyed.</p>
            </div>
        </div>
        <div className="flex flex-col gap-[30px] w-[220px]">
            ...
            <div className="flex flex-col gap-1">
                <p className="font-bold text-2xl leading-[36px] text-white">Best Awards</p>
                <p className="leading-[30px] text-flysha-off-purple">Our jets protected by metal that can’t be destroyed.</p>
            </div>
        </div>
        <div className="flex flex-col gap-[30px] w-[220px]">
            ...
            <div className="flex flex-col gap-1">
                <p className="font-bold text-2xl leading-[36px] text-white">Pickup at Home</p>
                <p className="leading-[30px] text-flysha-off-purple">Our jets protected by metal that can’t be destroyed.</p>
            </div>
        </div>
    </div>
  ...
  <section id="Selected" className="container max-w-[1130px] mx-auto flex flex-col pt-[100px] gap-[30px]">
    <div className="flex justify-between items-center">
        <h2 className="font-bold text-[32px] leading-[48px] text-center  text-white">Best Selective</h2>
        <div className="flex gap-[10px]">
            <button className="flex shrink-0 w-10 h-10 items-center justify-center bg-white rounded-full">
                <Image width={20} height={20} src="/assets/images/icons/arrow-right.svg" className="rotate-180" alt="icon" />
            </button>
            <button className="flex shrink-0 w-10 h-10 items-center justify-center bg-white rounded-full">
    ...
    <div className="grid grid-cols-4 gap-[30px]">
        <div className="flex flex-col gap-5">
            <div className="rounded-[30px] h-[310px] overflow-hidden">
                <Image width={40} height={40} src="/assets/images/thumbnail/thumbnail1.png" className="w-full h-[310px] object-cover" alt="thumbnail" />
            </div>
            <div className="flex gap-[14px] items-center">
                <div className="flex shrink-0 w-8 h-8">
                    <Image width={40} height={40} src="/assets/images/icons/crown-white.svg" className="w-8 h-8" alt="icon" />
                </div>
                <div className="flex flex-col gap-[2px]">
                    <p className="font-bold text-lg  text-white">First Lounge</p>
        ...
        <div className="flex flex-col gap-5">
            <div className="rounded-[30px] h-[310px] overflow-hidden">
                <Image width={40} height={40} src="/assets/images/thumbnail/thumbnail2.png" className="w-full h-[310px] object-cover" alt="thumbnail" />
            </div>
            <div className="flex gap-[14px] items-center">
                <div className="flex shrink-0 w-8 h-8">
                    <Image width={40} height={40} src="/assets/images/icons/crown-white.svg" className="w-8 h-8" alt="icon" />
                ...
                <div className="flex flex-col gap-[2px]">
                    <p className="font-bold text-lg  text-white">Business First</p>
        ...
        <div className="flex flex-col gap-5">
            <div className="rounded-[30px] h-[310px] overflow-hidden">
                <Image width={40} height={40} src="/assets/images/thumbnail/thumbnail3.png" className="w-full h-[310px] object-cover" alt="thumbnail" />
            </div>
            <div className="flex gap-[14px] items-center">
                <div className="flex shrink-0 w-8 h-8">
                    <Image width={40} height={40} src="/assets/images/icons/crown-white.svg" className="w-8 h-8" alt="icon" />
                ...
                <div className="flex flex-col gap-[2px]">
                    <p className="font-bold text-lg  text-white">Pickup at Home</p>
        ...
        <div className="flex flex-col gap-5">
            <div className="rounded-[30px] h-[310px] overflow-hidden">
                <Image width={40} height={40} src="/assets/images/thumbnail/thumbnail4.png" className="w-full h-[310px] object-cover" alt="thumbnail" />
            </div>
            <div className="flex gap-[14px] items-center">
                <div className="flex shrink-0 w-8 h-8">
                    <Image width={40} height={40} src="/assets/images/icons/crown-white.svg" className="w-8 h-8" alt="icon" />
                ...
                <div className="flex flex-col gap-[2px]">
                    <p className="font-bold text-lg  text-white">Fly Roam</p>
        ...
        <div className="slider flex shrink-0 w-max">
            <div className="animate-[slide_15s_linear_infinite] flex gap-[30px] pl-[30px] items-center h-[228px]">
                <div className="testi-cards flex flex-col gap-[14px] h-full w-fit bg-flysha-bg-purple p-5 rounded-[20px] overflow-hidden">
                    <p className="review leading-[30px] h-[90px] w-[305px]  text-white">
                        I thought cheaper was not good, well, I personally never had this amazing experience. Thank you!!
                    </p>
                    <div className="flex">
                        <Image width={30} height={30} src="../assets/images/icons/Star.svg" className="w-5 h-5" alt="star" />
                        <Image width={30} height={30} src="../assets/images/icons/Star.svg" className="w-5 h-5" alt="star" />
                        <Image width={30} height={30} src="../assets/images/icons/Star.svg" className="w-5 h-5" alt="star" />
                        <Image width={30} height={30} src="../assets/images/icons/Star.svg" className="w-5 h-5" alt="star" />
                        <Image width={30} height={30} src="../assets/images/icons/Star.svg" className="w-5 h-5" alt="star" />
                    ...
                    <div className="flex gap-4 items-center">
                        <div className="flex shrink-0 rounded-full w-[50px] h-[50px] overflow-hidden">
                            <Image width={30} height={30} src="../assets/images/photos/Group 47.png" className="w-full h-full object-cover" alt="photo" />
                        </div>
                        <div className="flex flex-col gap-[2px]">
                            <p className="font-bold  text-white">Jessi Lyio</p>
  ...
  <footer className="flex flex-col justify-between mt-[150px] border-t-[6px] border-flysha-light-purple p-[100px_10px_30px]  text-white">
      <div className="container max-w-[1130px] mx-auto flex justify-between relative">
        ...
        <div className="flex shrink-0 h-fit z-10">
            <Image width={180} height={100} src="/assets/images/logos/logo.svg" alt="" />
        </div>
