...
import { type Checkout, CHECKOUT_KEY, dateFormat, rupiahFormat, SEAT_VALUES, type SeatValuesType } from '@/lib/utils'
    ...
    const continueBook = () => {
        if (seat === null) {
            toast({
                ...
                description: 'Please choose your seat first',
            })
            return;
        }
            ...
            <div className="flex flex-col gap-[10px] w-full">
                ...
                <div className="flex justify-between">
                    <div className="flex flex-col gap-[2px] text-center">
                        <p className="font-bold text-lg">{dateFormat(flight.departureDate, "HH:mm")}</p>
                        <p className="text-sm text-flysha-off-purple">
                            {flight.departureCityCode}
                        </p>
                    </div>
                    <div className="flex flex-col gap-[2px] text-center">
                    <p className="font-bold text-lg">{dateFormat(flight.arrivalDate, "HH:mm")}</p>
                        <p className="text-sm text-flysha-off-purple">
            ...
            <div className="flex flex-col gap-4 w-full">
                ...
                <div className="flex justify-between items-center">
                    <div className="flex flex-col gap-[2px]">
                        ...
                        <p className="text-sm text-flysha-grey">{flight.plane.code} • {selectedSeat.label} Class</p>
                    </div>
